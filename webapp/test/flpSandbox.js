		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Freestyle application",
									"targetURL": "#comibmzcaseprd00zcaseprdfs00-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzcaseprd00zcaseprdfs00-display": {
								"semanticObject": "comibmzcaseprd00zcaseprdfs00",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zcaseprd00.zcaseprdfs00",
									"url": sap.ui.require.toUrl("com/ibm/zcaseprd00/zcaseprdfs00")
								}
							}
						}
					}
